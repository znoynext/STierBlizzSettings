...
- Concise result preview without a technical CVar list, with separate changed/already-matching/skipped/unavailable/failed counts and an explicit confirmation before applying.
