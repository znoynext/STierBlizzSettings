...
- Backup restore clearly distinguishes complete, partial and unavailable results. Compatible legacy settings still restore safely when another saved CVar was removed or is unavailable, and the status reports exact restored and unavailable counts instead of claiming full success.
