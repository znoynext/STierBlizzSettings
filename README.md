...
1. Download [STierBlizzSettings-v0.4.16-alpha.zip](https://github.com/znoynext/STierBlizzSettings/raw/refs/heads/main/dist/STierBlizzSettings-v0.4.16-alpha.zip).
...
- A four-card Graphics dashboard with live FPS and color-coded before, after and change results from the automatic 5-second comparison, plus a dedicated Test FPS dashboard with a cancellable 20-second test, explained stability, actionable hints and visual current-vs-preset comparisons.
...
Current version: **0.4.16-alpha**. Baseline: Retail 12.0.7, Interface 120007, Blizzard UI build 68453. Live-client visual testing and controlled hardware benchmarks are still required before declaring v1.0 production-ready.
