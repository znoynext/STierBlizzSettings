...
- Combat-delayed Graphics, Zone Graphics, UI Tweaks and recovery operations share one verified completion workflow, so Pending always resolves to a clear final status and failed work cannot claim applied state.
