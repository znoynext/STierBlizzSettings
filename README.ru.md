...
- Отложенные из-за боя графика, Zone Graphics, UI Tweaks и восстановление завершаются единым проверенным процессом: статус Pending всегда сменяется понятным итогом, а ошибка не помечает настройки как применённые.
