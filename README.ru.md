...
1. Скачайте [STierBlizzSettings-v0.4.18-alpha.zip](https://github.com/znoynext/STierBlizzSettings/raw/refs/heads/main/dist/STierBlizzSettings-v0.4.18-alpha.zip).
...
- **UI Tweaks** содержит только проверенные CVar актуального Retail: рекомендуемую резкость/свечение для всех пресетов и дополнительные эффекты смерти/мира духов. Раздел работает автономно: графические пресеты никогда не меняют его значения. Есть чекбоксы, ползунок, краткие подсказки, отдельный бэкап и возврат назад.
...
Текущая версия: **0.4.18-alpha**. Базовая совместимость: Retail 12.0.7, Interface 120007, Blizzard UI build 68453. До production v1.0 требуется визуальная проверка в живом клиенте и контролируемые аппаратные бенчмарки.
