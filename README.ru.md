...
- В разделе «Профили» есть отдельные представления для личных профилей, истории бэкапов и импорта/экспорта. `STBSA1` переносит графику, доступные UI Tweaks, выбранные пресет/режим, сохранённый benchmark mode, состояние индикатора, правила зон и личные профили; история и экранные позиции не экспортируются.
