...
- Восстановление бэкапа отдельно сообщает полный, частичный и недоступный результат. Совместимые legacy-настройки безопасно восстанавливаются, даже если другая сохранённая CVar была удалена или недоступна, а статус честно показывает точное число восстановленных и недоступных значений.
