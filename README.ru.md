...
- Краткий предпросмотр результата без технического списка CVar, с отдельными счётчиками изменений, совпадений, пропущенных, недоступных и ошибочных настроек, и отдельное подтверждение перед применением.
