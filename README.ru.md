...
Аддон автоматически использует язык клиента WoW: русский клиент получает русский интерфейс, французский — французский, английский и все пока не переведённые языки — полный английский интерфейс. Регион, учётная запись и сеть для этого не используются.
