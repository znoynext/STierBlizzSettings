...
11. Test at 100%, 125% and 150% UI scale, long translated labels, larger fonts, window/page/status/hover animations, scroll/focus/escape behavior, gold minimap icon and the real screenshot texture.
