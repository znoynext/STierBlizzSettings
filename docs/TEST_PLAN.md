...
12. Test at 100%, 125% and 150% UI scale, minimum/default/maximum window sizes, long translated labels, larger fonts, window/page/status/hover animations, scroll/focus/escape behavior, header-only movement, resize persistence and the gold minimap icon.
