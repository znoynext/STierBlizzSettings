...
local experience = {
  ...
  GRAPHICS_SETTINGS_TAB="Graphics Settings",
  ZONE_SWITCHER_TAB="Zone Graphics Switcher",
  ...
  RESTORE_FAILED_SUMMARY="Backup restore failed (%s).",
  RESTORE_QUEUED="Backup restore is queued until combat ends. The final result will be shown afterwards.",
  RESTORE_ROLLED_BACK="Backup restore failed. All attempted changes were rolled back safely.",
  RESTORE_ROLLBACK_FAILED="Backup restore failed and rollback was incomplete. Keep the safety backup for recovery.",
  QUICK_START="Quick start",
  QUICK_START_TEXT="1. Choose PRO, Optimized or Quality.\n2. Click Apply and confirm.\n3. Keep the same view during the 5-second comparison.",
  ...
  PLAN_SUMMARY="Result: %d will change, %d already match, %d skipped, %d unavailable, %d failed.",
  ...
  SPLIT="Lighter raids",
  GRAPHICS_SELECTION_SUMMARY="PRO prioritizes FPS; Optimized is the default balance; Quality improves the picture without wasteful maximums. Zone Graphics can switch these presets by content type.",
  ...
  FPS_TEST="Test FPS", FPS_TEST_TITLE="Test FPS", FPS_TEST_START="Start 20-second test", FPS_TEST_READY="Ready — stay in one scene and start the test.", FPS_TEST_RUNNING="Testing for 20 seconds… keep the same view.", FPS_TEST_PROGRESS="FPS test: %d / %d sec", FPS_TEST_COMPLETE="FPS test complete.", FPS_TEST_BUSY="Another FPS measurement is already running.", FPS_TEST_RESULTS="Latest result", FPS_TEST_DETAILS="Additional checks", FPS_TEST_NO_RESULT="No test result yet.", FPS_TEST_HELP="One 20-second test records every frame. 1% Low reveals brief drops; stability compares it with average FPS; spikes are frames slower than 50 ms or 2.5× your median. Keep the camera and scene stable.", FPS_TEST_AVERAGE="Average FPS: %d", FPS_TEST_ONE_LOW="1%% Low: %d FPS", FPS_TEST_STABILITY="Frame stability: %d%% · %s", FPS_TEST_SPIKES="Noticeable frame spikes: %d", FPS_TEST_WORST="Worst frame: %d ms", FPS_TEST_SUMMARY="Average %d FPS · 1%% Low %d", FPS_DASH_LIVE="Live FPS", FPS_DASH_AVERAGE="Average", FPS_DASH_ONE_LOW="1% Low", FPS_DASH_STABILITY="Stability", FPS_STABILITY_EXCELLENT="Excellent", FPS_STABILITY_GOOD="Good", FPS_STABILITY_UNEVEN="Uneven", FPS_STABILITY_POOR="Poor",
  FPS_DASH_BEFORE="Before apply", FPS_DASH_AFTER="After apply", FPS_DASH_CHANGE="Change", FPS_DASH_LIVE_NOTE="Real time", FPS_DASH_BEFORE_NOTE="Previous graphics", FPS_DASH_AFTER_NOTE="Applied graphics", FPS_DASH_CHANGE_NOTE="No comparison yet", FPS_GRAPHICS_DASH_LEGEND="Local 5-second measurement in the same scene",
  FPS_TEST_MODAL_TITLE="Measuring FPS", FPS_COMPARE_MODAL_TITLE="Comparing with %s", FPS_TEST_MODAL_HELP="Keep the same view. Do not move the camera, minimize WoW, or use Alt+Tab.", FPS_TEST_MODAL_PHASE="Measuring every frame", FPS_COMPARE_CURRENT="Step 1 of 2 · Your current graphics", FPS_COMPARE_SWITCH="Applying %s safely…", FPS_COMPARE_PRESET="Step 2 of 2 · %s", FPS_COMPARE_RESTORE="Restoring your graphics…", FPS_TEST_MODAL_PROGRESS="%d / %d sec", FPS_TEST_CANCEL="Cancel test", FPS_TEST_CANCELLED="Test cancelled. Nothing was changed.", FPS_TEST_CANCELLED_QUEUED="Test cancelled. Your graphics will be restored after combat.", FPS_TEST_CANCELLED_FAILED="Test cancelled, but graphics could not be restored. Use the latest backup in Profiles.", FPS_TEST_UNAVAILABLE="The FPS test is unavailable in this client session.",
  FPS_TEST_STABILITY_EXPLAIN="Stability %d%% means that 1%% Low is this close to your average FPS. Closer to 100%% feels smoother.", FPS_TEST_ADVICE="What this result suggests", FPS_DIAG_LOW="Sustained FPS is low. Compare PRO; shadows, view distance and spell effects are common high-cost settings.", FPS_DIAG_UNEVEN="Frame pacing is uneven. Repeat the same scene, then compare PRO. Combat effects, addon work and background asset loading can cause brief drops.", FPS_DIAG_HITCH="Average FPS is healthy, but an isolated hitch occurred. Repeat the same scene; loading new assets or addon work may be responsible.", FPS_DIAG_HEALTHY="Frame pacing looks healthy in this scene. Repeat the test in raid combat before making a final choice.", FPS_DIAG_LIMIT="These are measured symptoms, not a hardware diagnosis: addons cannot read GPU/CPU load or temperature.",
  FPS_COMPARE_BUTTON="Compare %s · 2×20 sec", FPS_COMPARE_RESULT_TITLE="Your graphics → %s", FPS_COMPARE_AVERAGE="Average FPS: %d → %d (%+d%%)", FPS_COMPARE_LOW="1%% Low: %d → %d (%+d%%)", FPS_COMPARE_BETTER="This preset was faster in the tested scene.", FPS_COMPARE_WORSE="This preset was slower in the tested scene.", FPS_COMPARE_SIMILAR="The difference is within 5%% and may be normal run-to-run variation.", FPS_COMPARE_RESTORED="Your original graphics were restored automatically.", FPS_COMPARE_RESTORE_QUEUED="Restoration is queued until combat ends.", FPS_COMPARE_RESTORE_FAILED="Automatic restoration failed. Restore the latest backup in Profiles.", FPS_COMPARE_COMPLETE="Comparison complete. Your graphics were restored.", FPS_COMPARE_COMPLETE_QUEUED="Comparison complete. Restoration will finish after combat.", FPS_COMPARE_COMPLETE_RESTORE_FAILED="Comparison complete, but restoration failed. Use the latest backup in Profiles.", FPS_COMPARE_FAILED="Comparison could not be completed", FPS_COMPARE_COMBAT="Preset comparison cannot start during combat.", FPS_COMPARE_PENDING="Finish the queued settings operation before comparing presets.",
  FPS_COMPARE_DASH_PRESET="Compared preset", FPS_COMPARE_DASH_HELP="Same scene, two 20-second measurements.", FPS_COMPARE_DASH_LEGEND="Left: my graphics   ·   Right: %s", FPS_COMPARE_DASH_VALUE="%d  |TInterface\\Buttons\\UI-SpellbookIcon-NextPage-Up:14:14|t  %d", FPS_COMPARE_DASH_PERCENT_VALUE="%d%%  |TInterface\\Buttons\\UI-SpellbookIcon-NextPage-Up:14:14|t  %d%%", FPS_COMPARE_DASH_DELTA="%+d FPS  (%+d%%)", FPS_COMPARE_DASH_POINTS="%+d points", FPS_COMPARE_FASTER_SHORT="Faster in this scene", FPS_COMPARE_SLOWER_SHORT="Slower in this scene", FPS_COMPARE_SIMILAR_SHORT="Nearly the same", FPS_COMPARE_MIXED_SHORT="Mixed result",
  FPS_COMPARE_RECOMMEND="%s improved both Average FPS and 1%% Low by at least 5%%. You can apply it now.",
  FPS_COMPARE_APPLY="Apply %s",
  FPS_COMPARE_APPLY_CONFIRM="Apply tested %s preset?",
  FPS_COMPARE_APPLY_CONFIRM_TEXT="Apply %d reviewed changes? A backup is created first; then a 5-second FPS check starts.",
  FPS_COMPARE_RECOMMEND_EXPIRED="This recommendation is no longer available. Run the comparison again.",
  FPS_APPLY_MEASURE_TITLE="Checking applied graphics",
  FPS_APPLY_MEASURE_HELP="Keep the same view while the addon measures the result.",
  FPS_APPLY_MEASURE_PHASE="Measuring FPS after apply",
  ...
  PROFILE_SAVE_MODE_UNAVAILABLE="Profile was not saved because Blizzard's Raid/Battleground mode could not be read.",
  PROFILE_SAVE_MODE_INVALID="Profile was not saved because Blizzard returned an unexpected Raid/Battleground mode.",
  ...
  SETTINGS_UNCHANGED="These settings are already active. Nothing was changed and no backup was created.",
  ...
  PENDING_GRAPHICS_FAILED="Queued graphics were not applied (%s). Your previous graphics remain active.",
  PENDING_RECOVERY_FAILED="Queued restore failed (%s). Use the latest backup in Profiles if needed.",
  ...
  ABOUT_BALANCE_BODY="PRO prioritizes FPS, Optimized is the recommended balance, and Quality raises useful detail without blindly maxing every option. All preserve high texture quality, projected ground effects, particles and outlines needed for combat readability. Zone Graphics can assign them separately by content type.",
  ABOUT_TRUST_HEADER="Why you stay in control",
  ABOUT_TRUST_BODY="Every real graphics change creates a backup first; an already-active preset creates no redundant history. You see a short preview and confirm before changes. Undo and Profiles can restore previous values. The addon stores data locally, has no telemetry and never changes resolution, render scale, V-Sync or FPS caps.",
  ...
  RESIZE_WINDOW="Drag to resize the addon window", CURRENT_PRESET="Current preset: %s", PRESET_CUSTOM="Custom",
...
local russianExperience = {
  ...
  PROFILE_SAVE_HELP="Текущая встроенная графика WoW сохранится как личный профиль.", PROFILE_SAVED="Профиль сохранён: %s", PROFILE_SAVE_FAILED="Профиль не сохранён", PROFILE_SAVE_MODE_UNAVAILABLE="Профиль не сохранён: не удалось прочитать режим Blizzard для рейдов и полей боя.", PROFILE_SAVE_MODE_INVALID="Профиль не сохранён: Blizzard вернул неожиданное значение режима для рейдов и полей боя.", PROFILE_RENAMED="Профиль переименован.", PROFILE_RENAME_FAILED="Профиль не переименован.", PROFILE_DELETED="Профиль удалён.", BACKUP_CREATED="Бэкап графики создан.", BACKUP_CREATE_FAILED="Бэкап не создан.", BACKUP_DELETED="Бэкап удалён.", ITEM_SELECTED="Выбрано: %s", EXPORT_READY="Экспорт создан. Нажмите «Копировать», затем Ctrl+C.", RELOAD_UI="Перезагрузить UI", RELOAD_CONFIRM="Перезагрузить интерфейс сейчас?", RELOAD_CONFIRM_TEXT="Настройки графики сохранены. Перезагрузка завершит обновление интерфейса и ненадолго вернёт вас на экран загрузки.", RELOAD_FAILED="Не удалось перезагрузить интерфейс WoW.", SETTINGS_APPLIED="Графика применена. Идёт быстрый замер FPS 5 секунд; затем появится предложение перезагрузить UI.", SETTINGS_APPLIED_NO_MEASURE="Графика применена. Открыто подтверждение перезагрузки UI.", ACTION_FAILED="Действие не выполнено.",
  ABOUT_TITLE="О S-Tier Blizz Settings", ABOUT_STATUS="Прозрачно: локально, обратимо и с документацией", ABOUT_SOURCE_HEADER="Откуда взяты настройки", ABOUT_SOURCE_BODY="Три пресета проверены по исходникам интерфейса Blizzard Retail, допустимым диапазонам CVar и внутриигровым валидаторам. У конкурентов изучались сценарии работы, но закрытый код и чужой визуальный стиль не копировались. Рекомендации учитывают цену теней, эффектов, плотности заклинаний и дальности прорисовки.", ABOUT_BALANCE_HEADER="Почему выбран этот баланс", ABOUT_BALANCE_BODY="PRO отдаёт приоритет FPS, Оптимальный даёт рекомендуемый баланс, а Качество повышает полезную детализацию без слепого включения максимумов. Все профили сохраняют качественные текстуры, эффекты на земле, частицы и контуры, важные в бою. Для разных типов контента можно отдельно назначить пресеты в Zone Graphics.", ABOUT_TRUST_HEADER="Почему контроль остаётся у вас", ABOUT_TRUST_BODY="Перед каждым реальным изменением графики создаётся бэкап; уже активный пресет не засоряет историю. Сначала показывается краткое описание и запрашивается подтверждение. «Вернуть назад» и «Профили» восстанавливают прежние значения. Аддон хранит всё локально, не использует телеметрию и не меняет разрешение, масштаб рендера, V-Sync и лимиты FPS.", ABOUT_LIMIT="Прирост FPS зависит от компьютера, места и нагрузки в бою. Сравнение — локальная оценка, а не гарантированный результат.",
  RESIZE_WINDOW="Потяните, чтобы изменить размер окна аддона", CURRENT_PRESET="Текущий пресет: %s", PRESET_CUSTOM="Custom",
  PROFILES_TAB="Профили", BACKUPS_TAB="Бэкапы", TRANSFER_TAB="Импорт / экспорт", PROFILE_COUNT="Сохранено профилей: %d", BACKUP_COUNT="Бэкапов графики: %d", TRANSFER_TITLE="Обмен всеми настройками аддона", TRANSFER_HELP="Экспорт создаёт одну строку с текущей графикой WoW, выбранным пресетом и режимом, правилами графики по зонам, режимом замера и личными профилями. Вставьте её на другом аккаунте, чтобы получить ту же конфигурацию.", TRANSFER_EXCLUDES="Положение окон на конкретном экране и история бэкапов не передаются.", EXPORT_ALL="Экспортировать все настройки", IMPORT_ALL="Импортировать все настройки", IMPORT_REVIEW="Проверить импорт", BUNDLE_EXPORT_READY="Строка со всеми настройками готова. Нажмите «Копировать», затем Ctrl+C.", BUNDLE_EXPORT_FAILED="Не удалось экспортировать настройки аддона.", BUNDLE_IMPORT_PASTE="Вставьте полную строку STBSA1 в большое поле ниже и нажмите «Проверить импорт».", BUNDLE_IMPORT_FAILED="Строка настроек не импортирована.", BUNDLE_IMPORT_SUMMARY="Будет применена общая графика и заменены личные профили (%d). Пресет: %s. Сначала будет создан бэкап графики.", IMPORT_ALL_CONFIRM="Импортировать и применить", BUNDLE_IMPORTED="Все переданные настройки аддона импортированы.",
  ACCURATE_CHECK="Точный замер 20 секунд", WIDGET_CHECK="Показывать FPS и пинг", ZONE_CHECK="Включить графику по зонам",
  FPS_TEST="Тест FPS", FPS_TEST_TITLE="Тест FPS", FPS_TEST_START="Запустить тест на 20 секунд", FPS_TEST_READY="Готово — остановитесь в одной сцене и запустите тест.", FPS_TEST_RUNNING="Тест идёт 20 секунд… не меняйте ракурс.", FPS_TEST_PROGRESS="Тест FPS: %d / %d сек", FPS_TEST_COMPLETE="Тест FPS завершён.", FPS_TEST_BUSY="Другой замер FPS уже выполняется.", FPS_TEST_RESULTS="Последний результат", FPS_TEST_DETAILS="Дополнительные проверки", FPS_TEST_NO_RESULT="Результатов теста пока нет.", FPS_TEST_HELP="Один тест за 20 секунд записывает каждый кадр. 1% Low показывает короткие просадки; стабильность сравнивает его со средним FPS; скачки — кадры медленнее 50 мс или в 2,5 раза медленнее медианы. Не меняйте сцену и ракурс.", FPS_TEST_AVERAGE="Средний FPS: %d", FPS_TEST_ONE_LOW="1%% Low: %d FPS", FPS_TEST_STABILITY="Стабильность кадров: %d%% · %s", FPS_TEST_SPIKES="Заметные скачки кадра: %d", FPS_TEST_WORST="Худший кадр: %d мс", FPS_TEST_SUMMARY="Средний %d FPS · 1%% Low %d", FPS_DASH_LIVE="Текущий FPS", FPS_DASH_AVERAGE="Средний", FPS_DASH_ONE_LOW="1% Low", FPS_DASH_STABILITY="Стабильность", FPS_STABILITY_EXCELLENT="Отлично", FPS_STABILITY_GOOD="Хорошо", FPS_STABILITY_UNEVEN="Неровно", FPS_STABILITY_POOR="Плохо",
  WIDGET_CHECK="Показывать окно FPS и пинга",
  FPS_DASH_BEFORE="До применения", FPS_DASH_AFTER="После применения", FPS_DASH_CHANGE="Изменение", FPS_DASH_LIVE_NOTE="В реальном времени", FPS_DASH_BEFORE_NOTE="Прежняя графика", FPS_DASH_AFTER_NOTE="Применённая графика", FPS_DASH_CHANGE_NOTE="Сравнения ещё нет", FPS_GRAPHICS_DASH_LEGEND="Локальный замер 5 секунд в одной сцене",
  FPS_TEST_MODAL_TITLE="Измерение FPS", FPS_COMPARE_MODAL_TITLE="Сравнение с %s", FPS_TEST_MODAL_HELP="Не меняйте ракурс, не двигайте камеру, не сворачивайте WoW и не используйте Alt+Tab.", FPS_TEST_MODAL_PHASE="Записываем каждый кадр", FPS_COMPARE_CURRENT="Шаг 1 из 2 · Ваша текущая графика", FPS_COMPARE_SWITCH="Безопасно применяем %s…", FPS_COMPARE_PRESET="Шаг 2 из 2 · %s", FPS_COMPARE_RESTORE="Возвращаем вашу графику…", FPS_TEST_MODAL_PROGRESS="%d / %d сек", FPS_TEST_CANCEL="Отменить тест", FPS_TEST_CANCELLED="Тест отменён. Настройки не изменены.", FPS_TEST_CANCELLED_QUEUED="Тест отменён. Ваша графика вернётся после боя.", FPS_TEST_CANCELLED_FAILED="Тест отменён, но вернуть графику не удалось. Восстановите последний бэкап в «Профилях».", FPS_TEST_UNAVAILABLE="Тест FPS недоступен в этой сессии клиента.",
  FPS_TEST_STABILITY_EXPLAIN="Стабильность %d%% показывает, насколько 1%% Low близок к среднему FPS. Чем ближе к 100%%, тем плавнее игра.", FPS_TEST_ADVICE="Что показывает результат", FPS_DIAG_LOW="Средний FPS стабильно низкий. Сравните с PRO: тени, дальность и эффекты заклинаний часто дают высокую нагрузку.", FPS_DIAG_UNEVEN="Кадры идут неровно. Повторите ту же сцену и сравните с PRO. Причиной могут быть боевые эффекты, работа аддонов или фоновая загрузка ресурсов.", FPS_DIAG_HITCH="Средний FPS хороший, но был единичный рывок. Повторите ту же сцену: возможна загрузка новых ресурсов или работа аддона.", FPS_DIAG_HEALTHY="В этой сцене кадры идут ровно. Перед окончательным выбором повторите тест в рейдовом бою.", FPS_DIAG_LIMIT="Это измеренные симптомы, а не диагноз железа: аддон не видит загрузку и температуру CPU/GPU.",
  FPS_COMPARE_BUTTON="Сравнить %s · 2×20 сек", FPS_COMPARE_RESULT_TITLE="Ваша графика → %s", FPS_COMPARE_AVERAGE="Средний FPS: %d → %d (%+d%%)", FPS_COMPARE_LOW="1%% Low: %d → %d (%+d%%)", FPS_COMPARE_BETTER="В этой сцене пресет оказался быстрее.", FPS_COMPARE_WORSE="В этой сцене пресет оказался медленнее.", FPS_COMPARE_SIMILAR="Разница меньше 5%% и может быть обычным разбросом между запусками.", FPS_COMPARE_RESTORED="Ваша исходная графика возвращена автоматически.", FPS_COMPARE_RESTORE_QUEUED="Возврат настроек завершится после боя.", FPS_COMPARE_RESTORE_FAILED="Не удалось вернуть графику автоматически. Восстановите последний бэкап в «Профилях».", FPS_COMPARE_COMPLETE="Сравнение завершено. Ваша графика возвращена.", FPS_COMPARE_COMPLETE_QUEUED="Сравнение завершено. Настройки вернутся после боя.", FPS_COMPARE_COMPLETE_RESTORE_FAILED="Сравнение завершено, но вернуть настройки не удалось. Используйте последний бэкап в «Профилях».", FPS_COMPARE_FAILED="Не удалось завершить сравнение", FPS_COMPARE_COMBAT="Сравнение пресетов нельзя запускать во время боя.", FPS_COMPARE_PENDING="Сначала завершите отложенную операцию с настройками.",
  FPS_COMPARE_DASH_PRESET="Проверенный пресет", FPS_COMPARE_DASH_HELP="Одна сцена, два замера по 20 секунд.", FPS_COMPARE_DASH_LEGEND="Слева: мои настройки   ·   Справа: %s", FPS_COMPARE_DASH_VALUE="%d  |TInterface\\Buttons\\UI-SpellbookIcon-NextPage-Up:14:14|t  %d", FPS_COMPARE_DASH_PERCENT_VALUE="%d%%  |TInterface\\Buttons\\UI-SpellbookIcon-NextPage-Up:14:14|t  %d%%", FPS_COMPARE_DASH_DELTA="%+d FPS  (%+d%%)", FPS_COMPARE_DASH_POINTS="%+d п.п.", FPS_COMPARE_FASTER_SHORT="Быстрее в этой сцене", FPS_COMPARE_SLOWER_SHORT="Медленнее в этой сцене", FPS_COMPARE_SIMILAR_SHORT="Почти без изменений", FPS_COMPARE_MIXED_SHORT="Смешанный результат",
  FPS_COMPARE_RECOMMEND="%s улучшил средний FPS и 1%% Low минимум на 5%%. Его можно применить сейчас.",
  FPS_COMPARE_APPLY="Применить %s",
  FPS_COMPARE_APPLY_CONFIRM="Применить проверенный пресет %s?",
  FPS_COMPARE_APPLY_CONFIRM_TEXT="Применить %d проверенных изменений? Сначала создастся бэкап, затем начнётся замер FPS на 5 секунд.",
  FPS_COMPARE_RECOMMEND_EXPIRED="Эта рекомендация больше недоступна. Запустите сравнение ещё раз.",
...
STBS.Locale.ruRU.SETTINGS_UNCHANGED="Эти настройки уже активны. Ничего не изменено, бэкап не создан."
...
STBS.Locale.ruRU.PENDING_GRAPHICS_FAILED="Отложенные настройки графики не применены (%s). Предыдущая графика сохранена."
STBS.Locale.ruRU.PENDING_RECOVERY_FAILED="Отложенное восстановление не выполнено (%s). При необходимости используйте последний бэкап в «Профилях»."
STBS.Locale.ruRU.RESTORE_COMPLETE_SUMMARY="Бэкап восстановлен: восстановлено %d, уже совпадало %d."
STBS.Locale.ruRU.RESTORE_PARTIAL_SUMMARY="Бэкап восстановлен частично: восстановлено %d, недоступно в этом клиенте %d."
STBS.Locale.ruRU.RESTORE_ALL_UNAVAILABLE="Бэкап не восстановлен: все настройки (%d) недоступны в этом клиенте."
STBS.Locale.ruRU.RESTORE_FAILED_SUMMARY="Не удалось восстановить бэкап (%s)."
STBS.Locale.ruRU.RESTORE_QUEUED="Восстановление бэкапа выполнится после боя. Затем аддон покажет окончательный результат."
STBS.Locale.ruRU.RESTORE_ROLLED_BACK="Не удалось восстановить бэкап. Все выполненные изменения безопасно отменены."
