...
local experience = {
  ...
  PERFORMANCE_WIDGET_HELP="Live FPS and the higher of Home/World latency. Hold Ctrl and drag with the mouse to move this window.",
  WIDGET_FPS_FORMAT="FPS %d",
  WIDGET_PING_FORMAT="Ping %d ms",
